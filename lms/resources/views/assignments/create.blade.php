<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Assignment untuk') }} {{ $module->title }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('assignments.store', $module) }}" class="space-y-4">
                        @csrf

                        <div>
                            <x-input-label for="title" value="Judul Assignment" />
                        ...
                        <div>
                            <x-input-label for="due_at" value="Batas Waktu (opsional)" />
